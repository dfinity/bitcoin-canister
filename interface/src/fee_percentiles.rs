...
use ic_btc_interface::MillisatoshiPerVbyte;
...
pub fn get_current_fee_percentiles() -> Vec<MillisatoshiPerVbyte> {
...
fn get_tx_fee_per_byte(
    ...
    if tx.vsize() > 0 {
        ...
        Some(((1000 * satoshi) / tx.vsize() as u64) as MillisatoshiPerVbyte)
    } else {
