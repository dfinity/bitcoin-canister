...
#[bench(raw)]
fn insert_large_block_with_many_transactions() -> BenchResult {
    ...
    let (block_1, block_2) = {
        ...
        for i in 0..tx_cardinality {
            tx_1 = tx_1.with_output(&address_1, 1).with_lock_time(i as u32)
        }
        let tx_1 = tx_1.build();
        ...
        for i in 0..tx_cardinality {
            tx_2 = tx_2.with_output(&address_2, 1).with_lock_time(i as u32);
        }
        let tx_2 = tx_2.build();
