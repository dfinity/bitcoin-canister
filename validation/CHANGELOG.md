...
- Rename usage of BlockHeader to Header for bitcoin crate v.0.32.4 update ([#345](https://github.com/dfinity/bitcoin-canister/pull/345))

- Update metadata of validation and test-utils crate ([#285](https://github.com/dfinity/bitcoin-canister/pull/285))
...
- Fix compute_next_difficulty and update bootstrap scripts for testnet4 ([#353](https://github.com/dfinity/bitcoin-canister/pull/353))
...
- Validate that the block is < 2 hours from the current time. ([#149](https://github.com/dfinity/bitcoin-canister/pull/149))
...
[0.2.0]: https://github.com/dfinity/bitcoin-canister/compare/0.1.0...0.2.0
