...
const BITCOIN_MAX_TARGET: Target = Target::from_be_bytes([
...
const TESTNET_MAX_TARGET: Target = Target::from_be_bytes([
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0xff,0xff,0x00,0x00,
...
/// Bitcoin testnet4 maximum target value
const TESTNET4_MAX_TARGET: Target = Target::from_be_bytes([
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0xff,0xff,0x00,0x00,
...
const REGTEST_MAX_TARGET: Target = Target::from_be_bytes([
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
const SIGNET_MAX_TARGET: Target = Target::from_be_bytes([
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x03,0x77,0xae,0x00,0x00,0x00,
]);
...
pub fn max_target(network: &Network) -> Target {
    match network {
        ...
        Network::Testnet4 => TESTNET4_MAX_TARGET,
